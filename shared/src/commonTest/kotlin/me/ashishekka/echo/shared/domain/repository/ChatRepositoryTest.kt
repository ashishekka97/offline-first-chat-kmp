...
class ChatRepositoryTest {
    ...
    fun testGetChatByIdMapsCorrectly() = runTest {
        val chat = ChatEntity("chat_1", "Original Title", "Msg", 1000L, 1000L, 1000L)
        chatDao.insertChat(chat)
        
        val result = repository.getChatById("chat_1").first()
        assertEquals("chat_1", result?.id)
    ...
    fun testOneOnOneChatTitleResolution() = runTest {
        ...
        val chat = ChatEntity("chat_1", "Group Title", null, 1000L, 1000L, 1000L)
    ...
    fun testGroupChatTitleRemainsSame() = runTest {
        ...
        val chat = ChatEntity("chat_1", "Team Alpha", null, 1000L, 1000L, 1000L)
        val p1 = ParticipantEntity(Constants.CURRENT_USER_ID, "Me", null, false)
        val p2 = ParticipantEntity("user_2", "Bob", null, false)
        val p3 = ParticipantEntity("user_3", "Charlie", null, false)
